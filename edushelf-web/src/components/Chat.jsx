...
const Chat = () => {
  ...
  const fetchMessages = async (sessionId) => {
    try {
      const fetched = await getChatMessages(sessionId);
      const formatted = fetched.flatMap(msg => {
        const userMsg = { sender: 'user', text: msg.message, image: msg.imagePath };
        return msg.response
          ? [userMsg, { sender: 'bot', text: msg.response }]
          : [userMsg];
      });
